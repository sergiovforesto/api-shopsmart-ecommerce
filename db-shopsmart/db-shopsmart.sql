...
INSERT INTO `payments` VALUES (1,'sergio ventura','2026-12-31',878,'$2b$10$GLnZDhl04kkMHb/BXczb7O.kjSgU8YlW5sfjaXEGCelUMxmZyd2Ym',1),(2,'pedro garcia','2025-10-22',799,'$2b$10$xr.lcUKaxt/4DsWE0A/hkeZor/YF31q2KLeBIvUX0FsLfIqTznMk2',2);
...
INSERT INTO `shipping_infos` VALUES (1,'Venezuela','caracas','Miranda','chacao','+7998425','1088',1),(3,'Venezuela','Pto Ayacucho','Amazonas','Alto parima','7844515','3256',2);
...
INSERT INTO `users` VALUES (1,'sergio','ventura','sergiovforesto@gmail.com','$2b$10$p9IfM8YZTAAmFKTfGGvSqOhFC19Kj.jA3//P2fY.Y/UTdJSmVTVCe',1,'','admin'),(2,'pedro','garcia','pedro@gmail.com','$2b$10$3p6knuWwVJPCNdOAPxHTD.b3ysYCbVEOwO9ggrAX7AP0LjWZ/gBmG',1,'','customer');
...
-- Dump completed on 2024-01-04  5:56:13
